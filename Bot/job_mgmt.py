...
class Job:
    ...
    @staticmethod
    def onEveryMinutes(minutes: int, task: Callable[..., Any], *args, **kwargs) -> None:
        """
        每 minutes 分钟执行
        :param minutes: 间隔，分钟
        :param task: 定时执行的方法
    ...
    @staticmethod
    def onEveryHours(hours: int, task: Callable[..., Any], *args, **kwargs) -> None:
        """
        每 hours 小时执行
        :param hours: 间隔，小时
        :param task: 定时执行的方法
    ...
    @staticmethod
    def onEveryDays(days: int, task: Callable[..., Any], *args, **kwargs) -> None:
        """
        每 days 天执行
        :param days: 间隔，天
        :param task: 定时执行的方法
    ...
    @staticmethod
    def onEveryTime(times: str | list, task: Callable[..., Any], *args, **kwargs) -> None:
        """
        每天定时执行
